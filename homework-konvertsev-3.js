...
function removeVowelLetters (word){
    let result1 = word.replace(/[аоуиіе]/gi, "");
    return console.log(result1);
}
removeVowelLetters("Максим Конверцев")
